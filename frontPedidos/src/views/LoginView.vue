<template>
  <div class="d-flex justify-content-center main">
    <div
      v-if="tipoForm == 'login'"
      class="card card-custom animate__animated animate__slideInRight bg-dark-opacity rounded-3"
    >
      <div class="card-body">
        <h3 class="text-center text-uppercase fs-5 text-white mb-5 uppercase">
          Iniciar sesión
        </h3>
        ...
        <div class="mt-4 text-center">
          <button
            @click="ingresar()"
            class="btn-custom border border-success rounded-5 text-white bg-outline-success"
          >
            Iniciar sesión
          </button>
        </div>
    ...
    <div
      v-if="tipoForm == 'registrarse'"
      class="card card-custom-reg animate__animated animate__slideInLeft bg-dark-opacity rounded-3"
    >
      <div class="card-body">
        <h3
          class="text-center text-uppercase uppercase fs-5 text-white mb-4 pb-2"
        >
          Registrarse
        </h3>
        ...
        <div class="mb-3 text-center">
          <p class="text-white mt-4">
            ...
            <label class="label ms-2 fw-bold" @click="ir('login')"
...
const registrar = async () => {
  ...
  try {
    ...
    alertInfo(
      "Bienvenido",
      `El usuario ${datos.nombre} se registro`,
      "success",
      "Iniciar sesion"
    );
    limpiarCampos();
